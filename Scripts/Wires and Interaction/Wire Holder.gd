...
func update_charge(depth = 0, cts = null):
	...
	reset_looked_at()
	if(cts == null): # recheck
		if(  connection1 != null and connection1.charge > 0 and connection1.is_connected_to_source()):
			cts = true
		elif(connection2 != null and connection2.charge > 0 and connection2.is_connected_to_source()):
			cts = true
		elif(connection3 != null and connection3.charge > 0 and connection3.is_connected_to_source()):
			cts = true
